...
class HUD(object):
    ...
    def tick(self, world, clock):
        ...
        # Check current lane change allowed
            "Current Lane change:  " + str(waypoint.lane_change),
        # Left and Right lane markings
            "L lane marking type: " + str(waypoint.left_lane_marking.type),
            "L lane marking change: " + str(waypoint.left_lane_marking.lane_change),
...
def main():
    ...
    argparser.add_argument(
        '--host',
        metavar='H',
        default='93.66.187.114',#'localhost',
